...
- `allowSSHport`: allow inbound [SSH](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connect-linux-inst-ssh.html). Option does not affect [EC2 Instance Connect](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-connect-methods.html#ec2-instance-connect-connecting-console) access. Default is `No`
...
To verify Amazon Bedrock [model access](https://docs.aws.amazon.com/bedrock/latest/userguide/model-access.html), select and interact with a model from the model catalog in the [Amazon Bedrock console playground](https://us-east-1.console.aws.amazon.com/bedrock/home?region=us-east-1#/homeplayground).
...
- [RStudio Server](https://docs.posit.co/ide/user/#rstudio-server-oss-downloads) / [Posit Workbench](https://docs.posit.co/ide/server-pro/admin/getting_started/installation/installation.html#download-and-install)
- [RStudio Desktop](https://docs.posit.co/ide/user/#rstudio-ide-oss-downloads) / [RStudio Desktop Pro](https://docs.posit.co/ide/user/#direct-downloads-commercial)
