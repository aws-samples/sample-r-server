...
- [RStudio Server](https://posit.co/download/rstudio-server/) / [Posit Workbench](https://docs.posit.co/ide/server-pro/admin/getting_started/installation/installation.html#download-and-install)
- [RStudio Desktop](https://posit.co/download/rstudio-desktop/) / [RStudio Desktop Pro](https://posit.co/download/rstudio-desktop-pro/)
